    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
          ...
          />
          {/* FAULT INJECTION MATRIX: Positioned in space below centerpiece to eliminate empty space */}
          <FaultInjectionPanel />
        </div>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
          ...
          >
            <MissionRecordingControls />
            <MaintenanceAdvisory onNavigate={onNavigate} />
          </div>
        </div>
      </section>
