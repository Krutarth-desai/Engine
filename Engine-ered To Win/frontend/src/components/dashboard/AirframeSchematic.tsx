...
export default function AirframeSchematic({
  ...
  // Status colors (nominal is neutral ivory at ~55% opacity, deviations take amber/red)
  const nominalStroke = "var(--schematic-stroke)";
  const rpmColor = rpmStatus === "NORMAL" ? nominalStroke : getStatusColor(rpmStatus);
  const chtColor = chtStatus === "NORMAL" ? nominalStroke : getStatusColor(chtStatus);
  const egtColor = egtStatus === "NORMAL" ? nominalStroke : getStatusColor(egtStatus);
  const oilColor = oilStatus === "NORMAL" ? nominalStroke : getStatusColor(oilStatus);
  const fuelColor = fuelStatus === "NORMAL" ? nominalStroke : getStatusColor(fuelStatus);
  const vibColor = vibStatus === "NORMAL" ? nominalStroke : getStatusColor(vibStatus);
    ...
    >
      ...
      {hoveredPart && (
        <div
          style={{
            ...
            border: `1px solid ${hoveredPart.status === "NORMAL" ? "var(--border)" : getStatusColor(hoveredPart.status)}`,
            borderRadius: "6px",
        ...
        >
          <div style={{ fontWeight: 800, color: "var(--text)", fontSize: "0.72rem" }}>
            {hoveredPart.name}
          </div>
          <div
            style={{
          ...
          <div style={{ fontSize: "0.58rem", color: "var(--accent)", marginTop: "0.25rem", borderTop: "1px solid var(--border)", paddingTop: "0.2rem" }}>
      ...
      >
          ...
          <linearGradient id="engineBlockGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="50%" stopColor="var(--surface-3)" />
        ...
        >
          ...
          >
            ...
            <rect
              ...
              height="36"
              rx="4"
              fill={focusedComponent === "fuel_flow" ? "var(--border)" : "url(#fuelCellGrad)"}
              stroke="var(--schematic-stroke)"
              strokeWidth={focusedComponent === "fuel_flow" ? 2 : 1.3}
            />
            {/* Anti-slosh Internal Baffles */}
            <line x1="198" y1="164" x2="198" y2="196" stroke="var(--schematic-stroke-subtle)" strokeWidth="1" strokeDasharray="2,2" />
            <line x1="224" y1="164" x2="224" y2="196" stroke="var(--schematic-stroke-subtle)" strokeWidth="1" strokeDasharray="2,2" />
            ...
            />
            <circle cx="282" cy="180" r="4.5" fill={fuelColor} />
          </g>

          {/* Ram-Air Dorsal NACA Cooling Ducts */}
          <polygon points="305,145 325,148 325,152 305,149" fill="var(--bg)" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
          <polygon points="305,215 325,212 325,208 305,211" fill="var(--bg)" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
          ...
          <line x1="336" y1="144" x2="336" y2="216" stroke="var(--text-muted)" strokeWidth="2.5" />
          <line x1="335" y1="144" x2="335" y2="216" stroke="var(--text-faint)" strokeWidth="1" strokeDasharray="3,2" />

          {/* Chromoly 4130 Tubular Engine Mount Truss */}
          <g id="engine-mount-truss" opacity="0.85">
            <line x1="336" y1="152" x2="352" y2="166" stroke="var(--text-muted)" strokeWidth="1.2" />
            <line x1="336" y1="208" x2="352" y2="194" stroke="var(--text-muted)" strokeWidth="1.2" />
            <line x1="336" y1="180" x2="348" y2="180" stroke="var(--text-muted)" strokeWidth="1.2" />
          </g>
          ...
          >
            ...
            <circle cx="340" cy="156" r="4" fill="var(--status-caution)" stroke="var(--status-warning)" strokeWidth="1" />
            {/* Lower Dynafocal Bushing */}
            <circle cx="340" cy="204" r="4" fill="var(--status-caution)" stroke="var(--status-warning)" strokeWidth="1" />
            {/* 3-Axis Piezoresistive Accelerometer Node */}
            <rect x="337" y="174" width="7" height="12" rx="1.5" fill={vibColor} />
          </g>
          ...
          >
            ...
            <g id="cyl-bank-starboard">
              ...
              <rect
                ...
                height="20"
                rx="2"
                fill={focusedComponent === "cht" ? "var(--border)" : "var(--surface-2)"}
                stroke={chtColor}
                strokeWidth={focusedComponent === "cht" ? 2 : 1.3}
              />
              {/* CNC Machined Cooling Fins */}
              <line x1="360" y1="139" x2="384" y2="139" stroke="var(--text)" strokeWidth="1" />
              <line x1="360" y1="142" x2="384" y2="142" stroke="var(--text)" strokeWidth="1" />
              {/* Red Silicone Spark Plug Boot */}
              <circle cx="372" cy="138" r="2" fill="var(--status-warning)" />
              {/* CHT Thermocouple Sensor Node 1 */}
              <circle cx="372" cy="143" r="3.5" fill={chtColor} />
              ...
              <rect
                ...
                strokeWidth={focusedComponent === "cht" ? 2 : 1.3}
              />
              <line x1="398" y1="139" x2="422" y2="139" stroke="var(--text)" strokeWidth="1" />
              <line x1="398" y1="142" x2="422" y2="142" stroke="var(--text)" strokeWidth="1" />
              <circle cx="410" cy="138" r="2" fill="var(--status-warning)" />
              {/* CHT Thermocouple Sensor Node 3 */}
              <circle cx="410" cy="143" r="3.5" fill={chtColor} />
            </g>
            ...
            <g id="cyl-bank-port">
              ...
              <rect
                ...
                strokeWidth={focusedComponent === "cht" ? 2 : 1.3}
              />
              <line x1="360" y1="218" x2="384" y2="218" stroke="var(--text)" strokeWidth="1" />
              <line x1="360" y1="221" x2="384" y2="221" stroke="var(--text)" strokeWidth="1" />
              <circle cx="372" cy="222" r="2" fill="var(--status-warning)" />
              {/* CHT Thermocouple Sensor Node 2 */}
              <circle cx="372" cy="217" r="3.5" fill={chtColor} />
              ...
              <rect
                ...
                strokeWidth={focusedComponent === "cht" ? 2 : 1.3}
              />
              <line x1="398" y1="218" x2="422" y2="218" stroke="var(--text)" strokeWidth="1" />
              <line x1="398" y1="221" x2="422" y2="221" stroke="var(--text)" strokeWidth="1" />
              <circle cx="410" cy="222" r="2" fill="var(--status-warning)" />
              {/* CHT Thermocouple Sensor Node 4 */}
              <circle cx="410" cy="217" r="3.5" fill={chtColor} />
            </g>

            {/* Cylinder Labels in Engine Bay Mode */}
            {viewMode === "engine" && (
              <g style={{ pointerEvents: "none" }}>
                <text x="364" y="134" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CYL 1</text>
                <text x="402" y="134" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CYL 3</text>
                <text x="364" y="231" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CYL 2</text>
                <text x="402" y="231" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CYL 4</text>
              </g>
            )}
          </g>
          ...
          >
            ...
            <circle cx="390" cy="170" r="3.5" fill={egtColor} />
            <circle cx="390" cy="190" r="3.5" fill={egtColor} />

            {viewMode === "engine" && (
              <text x="412" y="183" fill="var(--surface-3)" fontSize="5.5" fontFamily="var(--font-mono), monospace" fontWeight="700">
                INCONEL 4-1
              </text>
            )}
          </g>
          ...
          >
            ...
            <ellipse cx="463" cy="180" rx="10" ry="12" fill="var(--surface-3)" stroke="var(--text)" strokeWidth="1.2" />
            {/* Intercooler Duct Outlet */}
            <path d="M 463,168 L 472,165" stroke="var(--text)" strokeWidth="2.5" />
            {/* Wastegate Actuator Canister (Anodized Magenta) */}
            <rect x="446" y="158" width="9" height="7" rx="1.5" fill="var(--surface-3)" stroke="var(--border)" strokeWidth="0.8" />
            {/* Steel Linkage Control Rod */}
            <line x1="450" y1="165" x2="450" y2="174" stroke="var(--text)" strokeWidth="1.4" />
            <circle cx="444" cy="180" r="4" fill={injTimingColor} />

            {viewMode === "engine" && (
              <text x="448" y="152" fill="var(--status-warning)" fontSize="5.5" fontFamily="var(--font-mono), monospace" fontWeight="700">
                TURBO/WG
              </text>
            )}
          </g>
          ...
          >
            ...
            <line x1="352" y1="173" x2="352" y2="187" stroke="var(--schematic-stroke)" strokeWidth="1.2" />

            {/* Ram-Air Oil Cooler Matrix Radiator */}
            <rect x="330" y="196" width="14" height="11" rx="1.5" fill="var(--surface-2)" stroke="var(--schematic-stroke-subtle)" strokeWidth="1.2" />
            {/* Cooling Matrix Fin Tubes */}
            <line x1="333" y1="196" x2="333" y2="207" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
            <line x1="337" y1="196" x2="337" y2="207" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
            <line x1="341" y1="196" x2="341" y2="207" stroke="var(--schematic-stroke)" strokeWidth="0.8" />

            {/* Braided Scavenge Return Line */}
            <path d="M 337,196 L 337,185 L 348,185" fill="none" stroke="var(--schematic-stroke-subtle)" strokeWidth="1.2" />
            {/* Oil Sensor Node */}
            <circle cx="355" cy="180" r="4.5" fill={oilColor} />

            {viewMode === "engine" && (
              <text x="328" y="217" fill="var(--accent)" fontSize="5.5" fontFamily="var(--font-mono), monospace" fontWeight="700">
                OIL SUMP
              </text>
            )}
          </g>
          ...
          >
            ...
            <rect x="526" y="174" width="22" height="12" rx="2" fill="var(--surface-3)" stroke="var(--text-muted)" strokeWidth="1" />
          ...
          {viewMode === "thermal" && (
            <g id="thermal-flir-heatmap" style={{ pointerEvents: "none", mixBlendMode: "screen" }}>
              ...
              <text x="60" y="340" fill="var(--status-warning)" fontSize="8" fontFamily="var(--font-mono), monospace" fontWeight="800">
        ...
        <g id="hud-leader-callouts" style={{ pointerEvents: "none" }}>
          ...
          {viewMode === "full" && (
            <g id="full-airframe-callouts">
              ...
              <line x1="112" y1="165" x2="112" y2="105" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="112" y1="105" x2="90" y2="85" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="90" y1="85" x2="25" y2="85" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="112" cy="165" r="2.5" fill={busVoltageColor} />
              <g transform="translate(25, 68)">
                <rect x="0" y="0" width="105" height="24" rx="4" fill="var(--surface-1)" stroke={busVoltageColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">BUS VOLTAGE / ADC</text>
                <text x="6" y="19" fill={busVoltageColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{busVoltage.toFixed(1)} V • {busVoltageStatus}</text>
              </g>

              {/* Callout 2: FUEL SYSTEM (Mid Fuselage) */}
              <line x1="240" y1="162" x2="240" y2="95" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="240" y1="95" x2="215" y2="70" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="215" y1="70" x2="155" y2="70" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="240" cy="162" r="2.5" fill={fuelColor} />
              <g transform="translate(155, 53)">
                <rect x="0" y="0" width="100" height="24" rx="4" fill="var(--surface-1)" stroke={fuelColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">FUEL INJECTION</text>
                <text x="6" y="19" fill={fuelColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{fuel.toFixed(1)} L/h</text>
              </g>

              {/* Callout 3: CYLINDER HEAD TEMP (CHT 1–4) */}
              <line x1="390" y1="144" x2="390" y2="85" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="390" y1="85" x2="415" y2="60" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="415" y1="60" x2="480" y2="60" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="390" cy="144" r="2.5" fill={chtColor} />
              <g transform="translate(480, 48)">
                <rect x="0" y="0" width="112" height="24" rx="4" fill="var(--surface-1)" stroke={chtColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CHT (CYL 1–4)</text>
                <text x="6" y="19" fill={chtColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{cht.toFixed(1)} °C • {chtStatus}</text>
              </g>

              {/* Callout 4: INJECTION TIMING */}
              <line x1="455" y1="172" x2="455" y2="95" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="455" y1="95" x2="485" y2="65" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="485" y1="65" x2="620" y2="65" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="455" cy="172" r="2.5" fill={injTimingColor} />
              <g transform="translate(620, 53)">
                <rect x="0" y="0" width="115" height="24" rx="4" fill="var(--surface-1)" stroke={injTimingColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">INJECTION TIMING</text>
                <text x="6" y="19" fill={injTimingColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{injTiming.toFixed(1)}° BTDC • {injTimingStatus}</text>
              </g>

              {/* Callout 5: CRANKCASE VIBRATION */}
              <line x1="338" y1="185" x2="338" y2="250" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="338" y1="250" x2="310" y2="278" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="310" y1="278" x2="215" y2="278" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="338" cy="185" r="2.5" fill={vibColor} />
              <g transform="translate(215, 266)">
                <rect x="0" y="0" width="105" height="24" rx="4" fill="var(--surface-1)" stroke={vibColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">VIBRATION RMS</text>
                <text x="6" y="19" fill={vibColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{vib.toFixed(2)} g • {vibStatus}</text>
              </g>

              {/* Callout 6: OIL LUBRICATION CIRCUIT */}
              <line x1="355" y1="188" x2="355" y2="260" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="355" y1="260" x2="375" y2="280" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="375" y1="280" x2="390" y2="280" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="355" cy="188" r="2.5" fill={oilColor} />
              <g transform="translate(390, 268)">
                <rect x="0" y="0" width="125" height="24" rx="4" fill="var(--surface-1)" stroke={oilColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">OIL LUBRICATION</text>
                <text x="6" y="19" fill={oilColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{oilP.toFixed(0)} psi • {oilT.toFixed(0)} °C</text>
              </g>

              {/* Callout 7: EXHAUST GAS TEMP (EGT) */}
              <line x1="410" y1="192" x2="410" y2="260" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="410" y1="260" x2="435" y2="285" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="435" y1="285" x2="520" y2="285" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="410" cy="192" r="2.5" fill={egtColor} />
              <g transform="translate(520, 273)">
                <rect x="0" y="0" width="115" height="24" rx="4" fill="var(--surface-1)" stroke={egtColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">EGT EXHAUST</text>
                <text x="6" y="19" fill={egtColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{egt.toFixed(1)} °C • {egtStatus}</text>
              </g>

              {/* Callout 8: PUSHER PROPELLER SPEED (RPM) */}
              <line x1="562" y1="188" x2="562" y2="245" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="562" y1="245" x2="585" y2="268" stroke="var(--border)" strokeWidth="0.8" />
              <line x1="585" y1="268" x2="640" y2="268" stroke="var(--border)" strokeWidth="0.8" />
              <circle cx="562" cy="188" r="2.5" fill={rpmColor} />
              <g transform="translate(640, 256)">
                <rect x="0" y="0" width="105" height="24" rx="4" fill="var(--surface-1)" stroke={rpmColor} strokeWidth="0.8" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">PUSHER PROP</text>
                <text x="6" y="19" fill={rpmColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{Math.round(rpm).toLocaleString()} RPM</text>
              </g>
            </g>
          )}
          ...
          {viewMode === "engine" && (
            <g id="engine-bay-callouts">
              ...
              <line x1="248" y1="95" x2="248" y2="52" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <line x1="248" y1="52" x2="160" y2="52" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <circle cx="248" cy="95" r="2.5" fill={chtColor} />
              <g transform="translate(30, 40)">
                <rect x="0" y="0" width="125" height="24" rx="4" fill="var(--surface-1)" stroke={chtColor} strokeWidth="0.9" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CHT (CYL 1–4)</text>
                <text x="6" y="19" fill={chtColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{cht.toFixed(1)} °C • {chtStatus}</text>
              </g>

              {/* Callout 2: INJECTION TIMING & BOOST (Top Right) */}
              <line x1="380" y1="135" x2="380" y2="52" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <line x1="380" y1="52" x2="460" y2="52" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <circle cx="380" cy="135" r="2.5" fill={injTimingColor} />
              <g transform="translate(460, 40)">
                <rect x="0" y="0" width="135" height="24" rx="4" fill="var(--surface-1)" stroke={injTimingColor} strokeWidth="0.9" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">INJ TIMING & TURBO</text>
                <text x="6" y="19" fill={injTimingColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{injTiming.toFixed(1)}° BTDC • {injTimingStatus}</text>
              </g>

              {/* Callout 3: VIBRATION RMS (Bottom Left) */}
              <line x1="138" y1="195" x2="138" y2="280" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <line x1="138" y1="280" x2="90" y2="280" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <circle cx="138" cy="195" r="2.5" fill={vibColor} />
              <g transform="translate(20, 268)">
                <rect x="0" y="0" width="115" height="24" rx="4" fill="var(--surface-1)" stroke={vibColor} strokeWidth="0.9" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">CRANKCASE VIB</text>
                <text x="6" y="19" fill={vibColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{vib.toFixed(2)} g • {vibStatus}</text>
              </g>

              {/* Callout 4: OIL LUBRICATION (Bottom Center) */}
              <line x1="180" y1="210" x2="230" y2="280" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <circle cx="180" cy="210" r="2.5" fill={oilColor} />
              <g transform="translate(230, 268)">
                <rect x="0" y="0" width="130" height="24" rx="4" fill="var(--surface-1)" stroke={oilColor} strokeWidth="0.9" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">DRY SUMP OIL CIRCUIT</text>
                <text x="6" y="19" fill={oilColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{oilP.toFixed(0)} psi • {oilT.toFixed(0)} °C</text>
              </g>

              {/* Callout 5: EGT EXHAUST (Bottom Right) */}
              <line x1="310" y1="215" x2="385" y2="280" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <circle cx="310" cy="215" r="2.5" fill={egtColor} />
              <g transform="translate(385, 268)">
                <rect x="0" y="0" width="125" height="24" rx="4" fill="var(--surface-1)" stroke={egtColor} strokeWidth="0.9" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">EGT 4-INTO-1 EXHAUST</text>
                <text x="6" y="19" fill={egtColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{egt.toFixed(1)} °C • {egtStatus}</text>
              </g>

              {/* Callout 6: PUSHER PROPELLER (Far Right) */}
              <line x1="626" y1="180" x2="626" y2="260" stroke="var(--schematic-stroke)" strokeWidth="0.8" />
              <circle cx="626" cy="180" r="2.5" fill={rpmColor} />
              <g transform="translate(565, 260)">
                <rect x="0" y="0" width="115" height="24" rx="4" fill="var(--surface-1)" stroke={rpmColor} strokeWidth="0.9" />
                <text x="6" y="10" fill="var(--text-muted)" fontSize="6.5" fontFamily="var(--font-mono), monospace" fontWeight="700">PUSHER PROPELLER</text>
                <text x="6" y="19" fill={rpmColor} fontSize="7.5" fontFamily="var(--font-mono), monospace" fontWeight="800">{Math.round(rpm).toLocaleString()} RPM</text>
              </g>
            </g>
          )}
          ...
          {viewMode === "thermal" && (
            <g id="thermal-mode-callouts">
              <g transform="translate(20, 20)">
                <rect x="0" y="0" width="230" height="28" rx="4" fill="var(--surface-1)" stroke="var(--status-warning)" strokeWidth="1" />
                <text x="8" y="12" fill="var(--status-warning)" fontSize="7" fontFamily="var(--font-mono), monospace" fontWeight="800">
                  FLIR THERMAL SPECTRUM
                </text>
                <text x="8" y="22" fill="var(--border-strong)" fontSize="7" fontFamily="var(--font-mono), monospace">
